...
export MEMOLIST_TASK_MARKDOWN_FILE_PATH=$MEMOLIST_DIR_PATH/0000-00-00-task.md
export MEMOLIST_TMP_DOT_FILE_PATH=$MEMOLIST_DIR_PATH/0000-00-00-tmp.dot
export MEMOLIST_TMP_MARKDOWN_FILE_PATH=$MEMOLIST_DIR_PATH/0000-00-00-tmp.md
export MEMOLIST_TMP_SQL_FILE_PATH=$MEMOLIST_DIR_PATH/0000-00-00-tmp.sql
export MEMOLIST_TMP_TEXT_FILE_PATH=$MEMOLIST_DIR_PATH/0000-00-00-tmp.txt
export MEMOLIST_TMP_UML_FILE_PATH=$MEMOLIST_DIR_PATH/0000-00-00-tmp.uml
export MEMOLIST_TMP_JSON_FILE_PATH=$MEMOLIST_DIR_PATH/0000-00-00-tmp.json
