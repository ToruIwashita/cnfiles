...
export MARKDOWN_TEXTS_AI_INSTRUCTION_TEMPLATE_DIR_PATH=$MARKDOWN_TEXTS_DIR_PATH/ai/instruction_template
export MARKDOWN_TEXTS_AI_DEVELOPMENT_RULE_FILE_PATH=$MARKDOWN_TEXTS_DIR_PATH/ai/instruction_doc/ai_development_rule.md
export MARKDOWN_TEXTS_VIM_IMPLEMENTATION_GUIDE_FILE_PATH=$MARKDOWN_TEXTS_DIR_PATH/ai/code_implementation_guide/vim.md
export MARKDOWN_TEXTS_ZSH_IMPLEMENTATION_GUIDE_FILE_PATH=$MARKDOWN_TEXTS_DIR_PATH/ai/code_implementation_guide/zsh.md
