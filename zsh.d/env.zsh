...
export MARKDOWN_TEXTS_VIM_IMPLEMENTATION_GUIDE_FILE_PATH=$MARKDOWN_TEXTS_DIR_PATH/ai_prompt/code_implementation_guide/vim.md
export MARKDOWN_TEXTS_ZSH_IMPLEMENTATION_GUIDE_FILE_PATH=$MARKDOWN_TEXTS_DIR_PATH/ai_prompt/code_implementation_guide/zsh.md
