...
bindkey -v '^s;' save-claude-session                  # Ctrl+s,;でAIエージェントセッション保存
bindkey -v '^s:' peco-delete-claude-session           # Ctrl+s,:でAIエージェントセッション削除
bindkey -v "^s'" peco-delete-claude-session           # Ctr+s,'(Ctr+:)でAIエージェントセッション削除
bindkey -v '^s ' peco-resume-claude-session           # Ctrl+s,<SPACE>でAIエージェントセッション選択・起動
...
bindkey -v '^@' peco-resume-claude-session            # Ctrl+@でAIエージェントセッション選択・起動
