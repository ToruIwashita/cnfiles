...
TMP_LATEST_AI_PRECOMPACT_SNAPSHOT_FILE_PATH=$TMP_DIR_PATH/latest-ai-precompact-snapshot.md
...
MEMOLIST_TMP_PROMPT_FILE_PATH=$MEMOLIST_DIR_PATH/00-tmp-prompt.md

# memolist tmp dump prompt markdown file
MEMOLIST_TMP_DUMP_MARKDOWN_FILE_PATH=$MEMOLIST_DIR_PATH/00-tmp-dump.md
...
MEMOLIST_TMP_HTML_FILE_PATH=$MEMOLIST_DIR_PATH/00-tmp.html
...
MEMOLIST_DEEP_DIVE_PROBE_ISSUES_DIR_PATH=$MEMOLIST_DIR_PATH/deep-dive-probe/issues
