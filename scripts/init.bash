...
# works memolist deep-dive-probe dir
if [[ -d $MEMOLIST_DIR_PATH/deep-dive-probe ]]; then
  _printf "\e[32m$MEMOLIST_DIR_PATH/deep-dive-probe dir already exists\e[0m\n"
else
  _printf "\e[31mmkdir $MEMOLIST_DIR_PATH/deep-dive-probe\e[0m\n"
...
if [[ -f $MEMOLIST_TMP_DUMP_MARKDOWN_FILE_PATH ]]; then
  _printf "\e[32m$MEMOLIST_TMP_DUMP_MARKDOWN_FILE_PATH file already exists\e[0m\n"
else
  _printf "\e[31mcreate file $MEMOLIST_TMP_DUMP_MARKDOWN_FILE_PATH\e[0m\n"
  touch $MEMOLIST_TMP_DUMP_MARKDOWN_FILE_PATH
fi
...
# memolist tmp html file
if [[ -f $MEMOLIST_TMP_HTML_FILE_PATH ]]; then
  _printf "\e[32m$MEMOLIST_TMP_HTML_FILE_PATH file already exists\e[0m\n"
else
  _printf "\e[31mcreate file $MEMOLIST_TMP_HTML_FILE_PATH\e[0m\n"
  touch $MEMOLIST_TMP_HTML_FILE_PATH
fi
