...
let g:memolist_tmp_dump_markdown_file_path = $MEMOLIST_TMP_DUMP_MARKDOWN_FILE_PATH
let g:memolist_tmp_dump_html_file_path = $MEMOLIST_TMP_DUMP_HTML_FILE_PATH
let g:memolist_tmp_markdown_file_path = $MEMOLIST_TMP_MARKDOWN_FILE_PATH
let g:memolist_tmp_html_file_path = $MEMOLIST_TMP_HTML_FILE_PATH
